...
export FOAM_CC="scorep --online-access --user --mpp=mpi --thread=none --nomemory --instrument-filter=$FM_DIR/scripts_$READEX_MACHINE/RESULTSgcc/scorep.filt g++ -std=c++11 -m64 -I$MERIC_ROOT/include -DUSE_SCOREP"
