...
CCADMIN=CCadmin
RANLIB=ranlib
CC=${SCOREP_PREP} ${READEX_CC}
CCC=${SCOREP_PREP} ${READEX_CXX}
CXX=${SCOREP_PREP} ${READEX_CXX}
FC=gfortran
AS=as
...
# CC Compiler Flags
CCFLAGS=
CXXFLAGS=${READEX_CXX_FLAGS} ${READEX_OMP_FLAG} ${DSWITCH} ${MERIC_INC_PATH}
...
LDLIBSOPTIONS= -L${MKLROOT}/lib/intel64 -lmkl_intel_ilp64 -lmkl_core ${READEX_MKL_THREAD_LIB} ${READEX_OMP_LIB} ${MERIC_LIB_PATH} ${MERIC_LIBS} ${READEX_OMP_FLAG} -lmpi -Wl,-rpath=${MKLROOT}/lib/intel64 

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/bem4i

${CND_DISTDIR}/${CND_CONF}/bem4i: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}
	${CXX} -o ${CND_DISTDIR}/${CND_CONF}/bem4i ${OBJECTFILES} ${LDLIBSOPTIONS}
