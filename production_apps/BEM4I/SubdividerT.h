...
public:
  ...
  SubdividerT( MeshType &_m ) : attached_( nullptr ) {
    attach( _m );
  }
...
public: /// \name Interface 1
  ...
  //@{
  /// Subdivide the mesh \c _m \c _n times and create subdivision matrices.
  /// \see SubdividerT(MeshType&)
  ...
  bool operator( )(
    ...
    return prepare( _m ) &&
        subdivide( _m, _n, matrices, _update_points ) &&
        cleanup( _m );
  }
  //@}
...
public: /// \name Interface 2
  ...
  bool operator( )(
    ...
    return attached_ ? subdivide( *attached_, _n, matrices, _update_points )
        : false;
  }
...
protected:
  ...
  /// Subdivide mesh \c _m \c _n times and create subdivision matrices
