/*!
 * @file    RepresentationFormulaHelmholtz.cpp
 * @author  Jan Zapletal
 * @date    November 6, 2013
 * 
 */

#ifdef REPRESENTATIONFORMULAHELMHOLTZ_H

namespace bem4i {

template<class LO, class SC>
RepresentationFormulaHelmholtz<LO, SC>::RepresentationFormulaHelmholtz( ) {
}
...
template<class LO, class SC>
SC RepresentationFormulaHelmholtz<LO, SC>::evaluate(
    const SCVT *x
    ) const {
  //todo
  return 0.0;
...
template<class LO, class SC>
void RepresentationFormulaHelmholtz<LO, SC>::evaluate(
    const SCVT *x,
    LO n,
    bool interior,
    Vector<LO, SC> & values
...
#pragma omp parallel
  {
    ...
    BEIntegratorHelmholtz<LO, SC> integrator( this->space, qOrder, kappa,
        Steinbach );
...
template<class LO, class SC>
void RepresentationFormulaHelmholtz<LO, SC>::printParaviewVtu(
