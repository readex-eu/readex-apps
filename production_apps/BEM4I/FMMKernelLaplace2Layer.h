 ...
 * @brief   Header file for class FMMKernelLaplace2Layer
 * 
 */

#ifndef FMMKERNELLAPLACE2LAYER_H
#define	FMMKERNELLAPLACE2LAYER_H
...
namespace bem4i {
  ...
  class FMMKernelLaplace2Layer : public FMMKernel<LO, SC> {
  public:

    //! default constructor
    FMMKernelLaplace2Layer();

    //! copy constructor
    FMMKernelLaplace2Layer(const FMMKernelLaplace2Layer& orig);
     ...
     */
    FMMKernelLaplace2Layer(FastBESpace<LO, SC>* space, int nMax,
            int startLevel = 0, int quadOrder = 5);

    //! destructor 
    virtual ~FMMKernelLaplace2Layer();
...
#include "FMMKernelLaplace2Layer.cpp"

#endif	/* FMMKERNELLAPLACE2LAYER_H */
