...
sed -i 's/$READEX_INSTRUMENTATION/-DUSE_SCOREP/' build.config
sed -i 's:$READEX_SCOREP_FLAGS:--mpp=mpi --thread=omp --noopenmp --nomemory:' build.config
