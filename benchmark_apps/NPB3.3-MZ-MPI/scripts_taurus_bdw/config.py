...
root_folder = [('./bt.C.2_meric_dir',None)]
...
y_label = ordDict((('Blade summary', [('Energy consumption [J]', 'J')]),
                  ('Job info - hdeem', [('Runtime of function [s]', 's')])))
...
time_energy_vars = {'time': ('Job info - hdeem', 'Runtime of function [s]'),
                    'energy': ('Blade summary', 'Energy consumption [J]')}
...
#
#  2) all_nested_regs = ['B']
#all_nested_regs = ['x_solve','y_solve','z_solve','exch_qbc']
