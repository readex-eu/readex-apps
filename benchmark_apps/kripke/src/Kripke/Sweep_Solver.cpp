...
#ifdef READEX_LEVEL_1  	
	READEX_PHASE_START(Loop, "Loop",  SCOREP_USER_REGION_TYPE_COMMON);
#endif

    //READEX_PHASE_START(Main, "Main", SCOREP_USER_REGION_TYPE_LOOP);
...
{
READEX_REGION_DEFINE(SweepSubdomain);
READEX_REGION_START(SweepSubdomain, "SweepSubdomain", SCOREP_USER_REGION_TYPE_COMMON);
  ...
  delete comm;
READEX_REGION_STOP(SweepSubdomain);
}
