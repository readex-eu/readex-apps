...
READEX_REGION_DEFINE(LTimes);
READEX_REGION_START(LTimes, "LTimes", SCOREP_USER_REGION_TYPE_COMMON);
...
READEX_REGION_STOP(LTimes);
}

void Kernel_3d_GZD::LPlusTimes(Grid_Data *grid_data) {
READEX_REGION_DEFINE(LPlusTimes);
READEX_REGION_START(LPlusTimes, "LPlusTimes", SCOREP_USER_REGION_TYPE_COMMON);
...
READEX_REGION_DEFINE(scattering);
READEX_REGION_START(scattering, "scattering", SCOREP_USER_REGION_TYPE_COMMON);
...
READEX_REGION_DEFINE(source);
READEX_REGION_START(source, "source", SCOREP_USER_REGION_TYPE_COMMON);
