...
void Kernel_3d_DGZ::LTimes(Grid_Data *grid_data) {
  //std::cout << " MERIC_MeasureStart(DGZ_LTimes);" << std::endl;
  //MERIC_MeasureStart("DGZ_LTimes");
...
void Kernel_3d_DGZ::LPlusTimes(Grid_Data *grid_data) {
  //std::cout << "MERIC_MeasureStart(DGZ_LPlusTimes);" << std::endl;  
  //MERIC_MeasureStart("DGZ_LPlusTimes");
...
void Kernel_3d_DGZ::scattering(Grid_Data *grid_data){
  //std::cout << "MERIC_MeasureStart(DGZ_Scattering);" << std::endl;  
  //MERIC_MeasureStart("DGZ_Scattering");
...
void Kernel_3d_DGZ::source(Grid_Data *grid_data){
  //std::cout << "MERIC_MeasureStart(DGZ_Source);" << std::endl;   
...
void Kernel_3d_DGZ::sweep(Subdomain *sdom) {
  ...
  //std::cout << "sweep before openmp" << std::endl;
#ifdef KRIPKE_USE_OPENMP
#pragma omp parallel for
#endif
