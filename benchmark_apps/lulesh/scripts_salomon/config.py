...
#all_nested_regs = ['ApplyMaterialPropertiesForElems','CalcCourantConstraintForElems','CalcFBHourglassForceForElems',
#                   'CalcForceForNodes','CalcKinematicsForElems','CalcLagrangeElements','CalcMonotonicQGradientsForElems',
#                   'CalcMonotonicQRegionForElems','CalcQForElems','CalcTimeConstraintsForElems',
#                   'CalcVolumeForceForElements:1','CalcVolumeForceForElements:2','CalcVolumeForceForElems',
#                   'EvalEOSForElems','foo','InitStressTermsForElems','IntegrateStressForElems',
#                   'LagrangeElements','LagrangeLeapFrog','LagrangeNodal']

all_nested_regs = ['ApplyMaterialPropertiesForElems',
