...
root_folder = [('../lulesh_meric_dir',None)]
...
y_label = ordDict((('COUNTERS - RAPL:', [('AVG Energy summary [J]', 'J')]),('Job info - RAPL', [('AVG Runtime of function [s]', 's')])))
...
time_energy_vars = {'time': ('Job info - RAPL', 'AVG Runtime of function [s]'),'energy': ('COUNTERS - RAPL:', 'AVG Energy summary [J]')}
...
#all_nested_regs = ['ApplyMaterialPropertiesForElems','CalcFBHourglassForceForElems','CalcForceForNodes',
#'CalcVolumeForceForElems','LagrangeElements','LagrangeLeapFrog','LagrangeNodal']
#all_nested_regs = ['IntegrateStressForElems','CalcFBHourglassForceForElems','CalcKinematicsForElems','CalcQForElems','ApplyMaterialPropertiesForElems']
#all_nested_regs = ['LagrangeLeapFrog']
all_nested_regs = ['IntegrateStressForElems','CalcFBHourglassForceForElems','CalcKinematicsForElems','CalcQForElems','ApplyMaterialPropertiesForElems']
#all_nested_regs = ['IntegrateStressForElems', 'CalcFBHourglassForceForElems']
