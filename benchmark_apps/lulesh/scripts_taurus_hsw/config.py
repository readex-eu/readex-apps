...
#all_nested_regs = ['ApplyMaterialPropertiesForElems','CalcFBHourglassForceForElems','CalcForceForNodes','CalcKinematicsForElems',
#'CalcLagrangeElements','CalcMonotonicQGradientsForElems','CalcQForElems','CalcTimeConstraintsForElems',
#'CalcVolumeForceForElems','IntegrateStressForElems','LagrangeElements','LagrangeLeapFrog','LagrangeNodal']
...
#all_nested_regs = ['IntegrateStressForElems','CalcFBHourglassForceForElems','LagrangeElements']
#all_nested_regs  = ['CalcVolumeForceForElems','LagrangeElements']
all_nested_regs = ['IntegrateStressForElems','CalcFBHourglassForceForElems','CalcKinematicsForElems','CalcQForElems','ApplyMaterialPropertiesForElems']
