...
psc_frontend --apprun="./blasbench_ptf --dgemv 300,8192 --dgemm 150,2048 --tan 60000 --phase 75" --mpinumprocs=2 --ompnumthreads=14 --phase=$PHASE --tune=readex_intraphase --config-file=readex_config_ptf.xml --force-localhost --info=2 --selective-info=AutotuneAll,AutotunePlugins
