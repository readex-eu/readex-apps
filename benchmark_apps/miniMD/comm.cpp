...
{
#ifdef USE_SCOREP_MANUAL
SCOREP_USER_REGION_DEFINE(R7)
SCOREP_USER_REGION_BEGIN(R7, "COMM_EXCHANGE", SCOREP_USER_REGION_TYPE_COMMON)
#endif
  if(do_safeexchange)
...
{
#ifdef USE_SCOREP_MANUAL
SCOREP_USER_REGION_DEFINE(R6)
SCOREP_USER_REGION_BEGIN(R6, "COMM_BORDERS", SCOREP_USER_REGION_TYPE_COMMON)
#endif
