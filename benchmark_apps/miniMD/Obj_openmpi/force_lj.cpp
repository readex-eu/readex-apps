...
SCOREP_USER_REGION_BEGIN(R2, "FORCELJ_COMP_HALF", SCOREP_USER_REGION_TYPE_COMMON)
#endif
...
{
#ifdef USE_SCOREP_MANUAL
SCOREP_USER_REGION_DEFINE(R3)
SCOREP_USER_REGION_BEGIN(R3, "FORCELJ_COMP_HALF_THREADED", SCOREP_USER_REGION_TYPE_COMMON)
#endif
