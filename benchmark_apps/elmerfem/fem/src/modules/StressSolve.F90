...
!------------------------------------------------------------------------------
     ...
     READEX_REGION_DEFINE(bulk_assembly)

     READEX_REGION_DEFINE(default_solve)
...
1000   continue
       READEX_REGION_START(bulk_assembly, 'bulk_assembly', SCOREP_USER_REGION_TYPE_COMMON)

       CALL BulkAssembly()
       READEX_REGION_STOP(bulk_assembly)
...
3000   IF ( Transient .AND.(ConstantBulkMatrix .OR. &
       ...
       !--------------------------------------------
       READEX_REGION_START(default_solve, 'default_solve', SCOREP_USER_REGION_TYPE_COMMON)

       UNorm = DefaultSolve()
      READEX_REGION_STOP(default_solve)
