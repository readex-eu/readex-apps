...
!-------------------------------------------------------------------------------
       ...
       READEX_REGION_DEFINE(parallel_init_matrix)
!-------------------------------------------------------------------------------

READEX_REGION_START(parallel_init_matrix, 'parallel_init_matrix', SCOREP_USER_REGION_TYPE_COMMON)
...
READEX_REGION_STOP(parallel_init_matrix)
