      ...
      char *argv[] )
{
    ...
    * Parse command line
    *-----------------------------------------------------------*/                                                                                               
   READEX_REGION_DEFINE( main_phase );
   READEX_PHASE_START( main_phase, "main_phase", SCOREP_USER_REGION_TYPE_COMMON );

   READEX_REGION_DEFINE( set_up );
   READEX_REGION_START( set_up, "set_up", SCOREP_USER_REGION_TYPE_COMMON );
...
/* since we have already tested SetBoxValues above, use SetValues here */
   ...
   READEX_REGION_DEFINE( hypre_pcgsetup );
   READEX_REGION_START( hypre_pcgsetup, "hypre_pcgsetup", SCOREP_USER_REGION_TYPE_COMMON );
         
            HYPRE_PCGSetup( par_solver, (HYPRE_Matrix) par_A,
                         (HYPRE_Vector) par_b, (HYPRE_Vector) par_x );
   
   READEX_REGION_STOP( hypre_pcgsetup );  
   ...
   READEX_REGION_DEFINE( hypre_pcgsolve );
   READEX_REGION_START( hypre_pcgsolve, "hypre_pcgsolve", SCOREP_USER_REGION_TYPE_COMMON );
   
         HYPRE_PCGSolve( par_solver, (HYPRE_Matrix) par_A,
                         (HYPRE_Vector) par_b, (HYPRE_Vector) par_x );
   
   READEX_REGION_STOP( hypre_pcgsolve );  
